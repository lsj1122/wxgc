<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="text" label="大事记描述" align="center">
      </el-table-column>
    ...
    >
      ...
      >
        <el-form-item label="大事记描述" prop="text">
          <el-input
            type="textarea"
            :rows="8"
            v-model="temp.text"
...
import { simpleUploads } from "./api/ttfile.js";
import Pagination from "@/components/Pagination";
import { updateTtUploadFile } from "./api/ttuploadfile";
...
export default {
  ...
  methods: {
    ...
    handleEdit(scope) {
      ...
      this.temp = deepClone(scope.row); //拷贝数据，阻断v-mode,解决点击取消时，修改了table 页面的数据
      this.dialogFormVisible = true;
      this.$nextTick(() => {
