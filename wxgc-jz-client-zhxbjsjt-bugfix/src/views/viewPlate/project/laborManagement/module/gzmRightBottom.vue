<template>
  <div class="slgk">
    ...
    <div class="body" @scroll="scrollBox">
      <div class="boxd">
        <div
          v-for="(item, index) in zlList"
          :key="index"
          @click="preview(item.otherFilePath)"
        >
          <span :title="item.otherFilePath.substring(60)">{{
            item.otherFilePath.substring(60)
          }}</span>
...
export default {
  ...
  methods: {
    scrollBox() {
      ...
      console.log(111, bigs, bigsH, small);
