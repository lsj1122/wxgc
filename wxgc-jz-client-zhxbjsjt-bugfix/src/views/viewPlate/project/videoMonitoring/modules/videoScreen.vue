...
<!--          <div class="videokz" v-if="item.videxObject ? item.videxObject.videoType === '球机' : false">-->
<!--            <i-->
...
export default {
  ...
  data() {
    return {
      ...
      videobox: [{videxObject:{videoType:''}}, {videxObject:{videoType:''}},{videxObject:{videoType:''}},{videxObject:{videoType:''}}], //循环的数组
      videoboxNumber: "",
      videoWidth: "49%",
      videoheight: "48%",
      urlArr: [],
  ...
  methods: {
    ...
    playVideo() {
      ...
      console.log(this.$store.state.video.videoLength);
      ...
      if (this.videoboxNumber == 1) {
        //单个
        this.videobox = [{videxObject:{videoType:''}}];
      ...
      if (
        ...
        console.log(166,'this.videobox',this.videobox)
        this.playerOptions = arrLength.playerOptions;
      }
      return;
    ...
    changeVideoBox(n) {
      ...
      if (n == 4) {
        let arg = {videxObject:{videoType:''}};
        this.videobox = [];
        this.videoboxNumber = 4;
        for (let i = 0; i < this.videoboxNumber; i++) {
          this.videobox.push(JSON.parse(JSON.stringify(arg)));
        }
        this.videoWidth = "49%";
        this.videoheight = "48%";
        // 清空左边list的数据
    ...
    lunbo() {
      ...
      //
      console.log(330,'this.playerOptions',this.playerOptions);
      console.log(331,'this.videobox',this.videobox);
