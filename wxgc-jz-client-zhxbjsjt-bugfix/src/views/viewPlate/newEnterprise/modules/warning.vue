<template>
  <!-- 累计设配统计 -->
  <div>
    <div ref="echart" id="warning" style="width: 100%; height: 100%"></div>
  </div>
</template>

<script>
import echarts from "echarts";
import { selectEquipmentAlarmStatistics } from "../api.js";
...
export default {
  ...
  methods: {
    loadData() {
      selectEquipmentAlarmStatistics().then((res) => {
        if (res.code == "success") {
