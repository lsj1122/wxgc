  ...
  <div class="app-container">
    ...
    >
      <div style="position: absolute; top: 20px; right: 20px; display: flex">
        ...
        <!-- <upload-file v-if="zsklist.length>0" class="xuanquwenjian" file-type="*" ref="clearData" list-type="*" accept="*" max-size="100"   @change="getFile"/> -->
      </div>
      <el-row>
  ...
  data() {
    return {
      ...
      listQuery: {
        ...
        knowledgeBaseId: undefined, //点击后传的id
        knowledgeBaseType: 1,
        fileName: "",
      },
      searchLbInp: "",
      ...
      rules: {
        knowledgeBaseName: [{ required: true, message: "请选择类型", trigger: "change" }],
        currentZSKId: [
          {
            required: true,
            message: "请选择新增文件的类型",
