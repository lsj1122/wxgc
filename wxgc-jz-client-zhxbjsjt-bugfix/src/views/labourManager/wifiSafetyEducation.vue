<template>
  <div class="app-container">
    ...
    >
      <el-table-column fixed prop="certName" label="劳工姓名" align="center">
      </el-table-column>

      <el-table-column fixed prop="certNo" label="身份证号" align="center">
      </el-table-column>
        <el-table-column fixed prop="laborCompanyName" label="劳务公司" align="center">
      </el-table-column>
         <el-table-column fixed prop="lowQuestionNum" label="最低答题数量" align="center">
      </el-table-column>
          <el-table-column fixed prop="testResult" label="完成答题数量" align="center">
      </el-table-column>
          <el-table-column fixed prop="testTime" label="答题日期" align="center">
      </el-table-column>
        <el-table-column fixed prop="testResultName" label="答题状态" align="center">
      </el-table-column>
         <el-table-column fixed prop="phoneNo" label="手机号码" align="center">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    loadPageData() {
      ...
      getPageWIFISafe(this.listQuery)
        .then((res) => {
            console.log('wifi安全教育',res)
          if (res.code == "success") {
            this.tableData = res.data.records;
            //  this.tableData[0].certName ='11111111111111'
