<template>
  <div class="app-container">
    <!--搜索框-->
    <div class="btn">
      <el-button @click="change('0')">监测单位监测记录</el-button>
      <el-button @click="change('1')">施工单位监测记录</el-button>
    </div>
    <div class="middle">
    ...
    >
      ...
      >
        <template slot-scope="scope">
          <a style="color:#6db8ff;" :href="'/wxgc-api/wxgc/plus/tt-file/downLoadFile?filePath=' + scope.row.otherFilePath">下载</a>
          <el-divider direction="vertical"></el-divider>
          <a style="color:red;" slot="reference" @click="deleteRow(scope.$index, tableData)">删除</a>
        </template>
      </el-table-column>
    </el-table>
    <!--分页组件-->
