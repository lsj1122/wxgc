<template>
  <div class="boot">
    ...
    <el-table :data="tableData" style="width: 100%">
      ...
      <el-table-column prop="enterTime" label="单次过磅时间" align="center">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleFilter() {
      ...
      this.listQuery.searchStartTime = moment(this.enterTime[0]).format('YYYY-MM-DD HH:mm:ss'),
      this.listQuery.searchEndTime = moment(this.enterTime[1]).format('YYYY-MM-DD HH:mm:ss'),
      this.loadPageData();
    },
