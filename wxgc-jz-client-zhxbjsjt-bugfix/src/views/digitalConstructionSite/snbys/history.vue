...
export default {
  ...
  data() {
    return {
      ...
      //表头（主要是下载excel时候使用）
      columns: [
        {label: "设备序号", field: "serialNumber"},
        {label: "设备编号", field: "snbysNum"},
  ...
  methods: {
    ...
    loadPageData() {
      ...
      getPageEleWaterWorkData(params)
        .then((res) => {
          if (res.code == "success") {
