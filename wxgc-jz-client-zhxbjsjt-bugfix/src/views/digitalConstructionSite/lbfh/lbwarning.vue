  ...
  <div class="app-container">
    ...
    <div class="tablebox">
      ...
      >
        ...
        <el-table-column
          prop="commandWordDetail"
          label="命令字详情"
          align="center"
        >
        </el-table-column>
        <el-table-column prop="eventDetail" label="事件详情" align="center">
        </el-table-column>
...
import {getPageTtLbCf, getAllTdWorkData} from "./api/lbfh.js";
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {label: "命令字详情", field: "commandWordDetail"},
        {label: "事件详情", field: "eventDetail"},
