<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="sensorName" label="设备名称" align="center">
      </el-table-column>
      <el-table-column prop="sensorName" label="设备编号" align="center">
      </el-table-column>
      <el-table-column prop="sensorName" label="传感器名称" align="center">
      </el-table-column>
      <el-table-column prop="sensorId" label="传感器id" align="center">
      </el-table-column>
      <el-table-column prop="damageNum" label="损伤个数" align="center">
      </el-table-column>
      ...
      <el-table-column label="详情损伤" align="center" width="400">
        <template slot-scope="scope">
          <el-popover
            placement="bottom"
            width="400"
            ...
            style="width: 100%"
          >
            <el-table :data="scope.row.sensorDetailList" height="500">
              <el-table-column
                property="damagePosition"
                label="损伤位置"
              >
              </el-table-column>
              <el-table-column
