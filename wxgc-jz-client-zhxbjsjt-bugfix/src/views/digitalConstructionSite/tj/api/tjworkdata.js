 ...
 * @returns {AxiosPromise}
 */
export function getPageWarningData(params) {
  return request({
    url: '/wxgc-base-system/wxgc/plus/tj-warning-data/select/list',
    method: 'get',
    params
  })
}
 ...
 * @returns {AxiosPromise}
 */
export function TjCircleDataPage(params) {
  return request({
    url: '/wxgc-base-system/wxgc/plus/tj-circle-data/select/list',
    method: 'get',
    params
  })
}
 ...
 * @returns {AxiosPromise}
 */
export function TjWarningDataPage(params) {
  return request({
    url: '/wxgc-base-system/wxgc/plus/tj-warning-data/select/list',
    method: 'get',
    params
