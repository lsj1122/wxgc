  ...
  <div class="app-container">
    ...
    <div class="tablebox">
      ...
      >
        ...
        <el-table-column prop="uploadTime" label="抓拍时间" align="center" />
        <el-table-column prop="totalNum" label="总人数" align="center">
        </el-table-column>

        <el-table-column
          prop="wearingHelmetNum"
          label="已戴安全帽"
          align="center"
        >
        </el-table-column>
        <el-table-column
          prop="withoutHelmetNum"
          label="未戴安全帽"
          align="center"
        >
        </el-table-column>
        ...
        <el-table-column prop="violation" label="违章" align="center">
          <template slot-scope="scope">
            {{
              scope.row.violation == 0
                ? "未违章"
                : scope.row.violation == 1
                ? "违章"
                : ""
            }}
          </template>
        </el-table-column>
   <el-table-column prop="pictureUrl" label="抓拍照片" align="center">
          <template slot-scope="scope">
            <el-image
...
<script>
import { getPagePeopleMZP } from "./api/comment.js";
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { label: "抓拍时间", field: "uploadTime" },
        { label: "总人数", field: "totalNum" },
        { label: "已戴安全帽", field: "wearingHelmetNum" },
        { label: "未戴安全帽", field: "withoutHelmetNum" },
        { label: "违章", field: "violation" },
        { label: "抓拍照片", field: "pictureUrl" },
      ],
  ...
  methods: {
    ...
    loadPageData() {
      ...
      getPagePeopleMZP(this.listQuery)
        .then((res) => {
          if (res.code == "success") {
